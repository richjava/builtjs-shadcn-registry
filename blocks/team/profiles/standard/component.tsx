          ...
          {data.profiles.map((profile, index) => (
            <div key={index} className="text-center group">
              <div className="relative mb-4">
                <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-4 border-gray-200 group-hover:border-blue-500 transition-colors duration-300">
                  <Image
                    src={profile.image}
                    alt={profile.name}
                    width={128}
                ...
                {Object.entries(profile.social).map(([platform, url]) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-500 hover:text-white transition-colors duration-300"
                    >
