...
export default function LogosClientsNeobrutalism({ content }: LogosClientsProps) {
  const { data } = content

  if (!data) {
    return <div>No data provided for Logos Clients Neobrutalism.</div>
  }
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-8 mb-16">
          {data.clients.map((client, index) => (
            ...
            >
              <div className="relative h-16 mb-4 border-2 border-black bg-gray-50 shadow-[2px_2px_0px_#000000] p-2">
                <Image
                  src={client.logo}
                  alt={client.name}
                  fill
              ...
              <div className="text-center">
                <h3 className="font-bold text-black text-sm border-b border-black pb-1 mb-3">
                  {client.name}
                </h3>
                <a
                  href={client.website}
                  ...
                  className="inline-flex items-center space-x-1 text-black hover:text-gray-600 transition-colors border border-black bg-neon-green shadow-[1px_1px_0px_#000000] px-2 py-1"
                >
