...
const templatePreviews: TemplatePreview[] = [
  {
    category: "about",
    categoryLabel: "About",
    templateName: "about-landing-image-standard",
    templateUrl: "/preview/about-landing-image-standard",
    description: "About page landing with statistics"
  },
  {
    category: "main",
    categoryLabel: "Main",
    templateName: "main-hero-section-hero-section-standard",
    templateUrl: "/preview/main-hero-section-hero-section-standard",
    description: "Hero section for main landing pages"
  },
  {
    category: "main",
    categoryLabel: "Main",
    templateName: "main-call-to-action-call-to-action-standard",
    templateUrl: "/preview/main-call-to-action-call-to-action-standard",
    description: "Call to action section"
  },
  {
    category: "main",
    categoryLabel: "Main",
    templateName: "main-problem-solution-problem-solution-standard",
    templateUrl: "/preview/main-problem-solution-problem-solution-standard",
