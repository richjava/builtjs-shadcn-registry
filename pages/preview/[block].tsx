...
const blockComponents: Record<string, React.ComponentType<any>> = {
  'about-landing-standard': AboutLandingImage,
  'about-landing-minimal': AboutLandingMinimalImage,
  'about-landing-bold': AboutLandingBoldImage,
  'about-company-story-standard': AboutCompanyStoryNarrative,
  'about-company-story-minimal': AboutCompanyStoryMinimalNarrative,
  'about-company-story-bold': AboutCompanyStoryBoldNarrative,
  'about-values-standard': AboutValuesGrid,
  'about-values-minimal': AboutValuesMinimalGrid,
  'about-values-bold': AboutValuesBoldGrid,
  'about-team-standard': AboutTeamCards,
  'about-team-minimal': AboutTeamMinimalCards,
  'about-team-bold': AboutTeamBoldCards,
  'about-mission-standard': AboutMissionStatement,
  'about-mission-minimal': AboutMissionMinimalStatement,
  'about-mission-bold': AboutMissionBoldStatement,
