...
const blockComponents: Record<string, React.ComponentType<any>> = {
  'about-landing-standard-image': AboutLandingImage,
  'about-landing-minimal-image': AboutLandingMinimalImage,
  'about-landing-bold-image': AboutLandingBoldImage,
  'about-landing-standard-stats': AboutLandingStats,
  'about-landing-minimal-stats': AboutLandingMinimalStats,
  'about-landing-bold-stats': AboutLandingBoldStats,
  'about-company-story-standard-narrative': AboutCompanyStoryNarrative,
  'about-company-story-minimal-narrative': AboutCompanyStoryMinimalNarrative,
  'about-company-story-bold-narrative': AboutCompanyStoryBoldNarrative,
  'about-values-standard-grid': AboutValuesGrid,
  'about-values-minimal-grid': AboutValuesMinimalGrid,
  'about-values-bold-grid': AboutValuesBoldGrid,
  'about-team-standard-cards': AboutTeamCards,
  'about-team-minimal-cards': AboutTeamMinimalCards,
  'about-team-bold-cards': AboutTeamBoldCards,
  'about-mission-standard-statement': AboutMissionStatement,
  'about-mission-minimal-statement': AboutMissionMinimalStatement,
  'about-mission-bold-statement': AboutMissionBoldStatement,
  'header-simple-nav': SimpleNav,
  'main-landing-hero-section': HeroSection,
  'main-hero-section-standard-standard': MainHeroSectionStandard,
  'main-hero-section-minimal-minimal': MainHeroSectionMinimal,
  'main-hero-section-bold-bold': MainHeroSectionBold,
  'main-value-proposition-standard-standard': ValuePropositionStandard,
  'main-value-proposition-minimal-minimal': ValuePropositionMinimal,
  'main-value-proposition-bold-bold': ValuePropositionBold,
  'main-social-proof-standard-standard': SocialProofStandard,
  'main-social-proof-minimal-minimal': SocialProofMinimal,
  'main-social-proof-bold-bold': SocialProofBold,
  'main-call-to-action-standard-standard': CallToActionStandard,
  'main-call-to-action-minimal-minimal': CallToActionMinimal,
  'main-call-to-action-bold-bold': CallToActionBold,
  'main-trust-indicators-standard-standard': TrustIndicatorsStandard,
  'main-trust-indicators-minimal-minimal': TrustIndicatorsMinimal,
  'main-trust-indicators-bold-bold': TrustIndicatorsBold,
  'main-problem-solution-standard-standard': ProblemSolutionStandard,
  'main-problem-solution-minimal-minimal': ProblemSolutionMinimal,
  'main-problem-solution-bold-bold': ProblemSolutionBold,
  'main-contact-lead-generation-standard-standard': ContactLeadGenerationStandard,
  'main-contact-lead-generation-minimal-minimal': ContactLeadGenerationMinimal,
  'main-contact-lead-generation-bold-bold': ContactLeadGenerationBold,
  'features-showcase-standard-standard': FeaturesShowcase,
  'features-showcase-minimal-minimal': FeaturesShowcaseMinimal,
  'features-showcase-bold-bold': FeaturesShowcaseBold,
  'features-highlights-standard-standard': FeaturesHighlights,
  'features-highlights-minimal-minimal': FeaturesHighlightsMinimal,
  'features-highlights-bold-bold': FeaturesHighlightsBold,
  'features-capabilities-standard-standard': FeaturesCapabilities,
  'features-capabilities-minimal-minimal': FeaturesCapabilitiesMinimal,
  'features-capabilities-bold-bold': FeaturesCapabilitiesBold,
  'services-offerings-standard-standard': ServicesOfferings,
  'services-offerings-minimal-minimal': ServicesOfferingsMinimal,
  'services-offerings-bold-bold': ServicesOfferingsBold,
  'services-solutions-standard-standard': ServicesSolutions,
  'services-solutions-minimal-minimal': ServicesSolutionsMinimal,
  'services-solutions-bold-bold': ServicesSolutionsBold,
  'services-services-standard-standard': ServicesServices,
  'services-services-minimal-minimal': ServicesServicesMinimal,
  'services-services-bold-bold': ServicesServicesBold,
  'features-list-feature-grid': FeatureGrid,
  'footer-simple-footer': SimpleFooter,
  'pricing-pricing-cards': PricingCards,
  'team-profiles-standard-standard': TeamProfiles,
  'team-profiles-minimal-minimal': TeamProfilesMinimal,
  'team-profiles-bold-bold': TeamProfilesBold,
  'team-culture-standard-standard': TeamCulture,
  'team-culture-minimal-minimal': TeamCultureMinimal,
  'team-culture-bold-bold': TeamCultureBold,
  'team-members-standard-standard': TeamMembers,
  'team-members-minimal-minimal': TeamMembersMinimal,
  'team-members-bold-bold': TeamMembersBold,
  'faq-questions-standard-standard': FAQQuestionsStandard,
  'faq-questions-standard-minimal': FAQQuestionsMinimal,
  'faq-questions-standard-bold': FAQQuestionsBold,
  'faq-help-standard-standard': FAQHelpStandard,
  'faq-help-standard-minimal': FAQHelpMinimal,
  'faq-help-standard-bold': FAQHelpBold,
  'faq-support-standard-standard': FAQSupportStandard,
  'faq-support-standard-minimal': FAQSupportMinimal,
  'faq-support-standard-bold': FAQSupportBold,
  'logos-clients-standard-standard': LogosClientsStandard,
  'logos-clients-standard-minimal': LogosClientsMinimal,
  'logos-clients-standard-bold': LogosClientsBold,
  'logos-partners-standard-standard': LogosPartnersStandard,
  'logos-partners-standard-minimal': LogosPartnersMinimal,
  'logos-partners-standard-bold': LogosPartnersBold,
  'logos-brands-standard-standard': LogosBrandsStandard,
  'logos-brands-standard-minimal': LogosBrandsMinimal,
  'logos-brands-standard-bold': LogosBrandsBold,
  'newsletter-signup-standard-standard': NewsletterSignupStandard,
  'newsletter-signup-standard-minimal': NewsletterSignupMinimal,
  'newsletter-signup-standard-bold': NewsletterSignupBold,
  'newsletter-subscription-standard-standard': NewsletterSubscriptionStandard,
  'newsletter-subscription-standard-minimal': NewsletterSubscriptionMinimal,
  'newsletter-subscription-standard-bold': NewsletterSubscriptionBold,
  'newsletter-opt-in-standard-standard': NewsletterOptInStandard,
  'newsletter-opt-in-standard-minimal': NewsletterOptInMinimal,
  'newsletter-opt-in-standard-bold': NewsletterOptInBold,
  'blog-blog-article-standard-standard': BlogArticleStandard,
  'blog-blog-article-standard-minimal': BlogArticleMinimal,
  'blog-blog-article-standard-bold': BlogArticleBold,
  'blog-blog-posts-standard-standard': BlogPostsStandard,
  'blog-blog-posts-standard-minimal': BlogPostsMinimal,
  'blog-blog-posts-standard-bold': BlogPostsBold,
  'blog-featured-posts-standard-standard': FeaturedPostsStandard,
  'blog-featured-posts-standard-minimal': FeaturedPostsMinimal,
  'blog-featured-posts-standard-bold': FeaturedPostsBold,
  'gallery-portfolio-standard-standard': GalleryPortfolioStandard,
  'gallery-portfolio-standard-minimal': GalleryPortfolioMinimal,
  'gallery-portfolio-standard-bold': GalleryPortfolioBold,
  'gallery-products-standard-standard': GalleryProductsStandard,
  'gallery-products-standard-minimal': GalleryProductsMinimal,
  'gallery-products-standard-bold': GalleryProductsBold,
  'gallery-showcase-standard-standard': GalleryShowcaseStandard,
  'gallery-showcase-standard-minimal': GalleryShowcaseMinimal,
  'gallery-showcase-standard-bold': GalleryShowcaseBold,
  'pricing-plans-standard-standard': PricingPlansStandard,
  'pricing-plans-standard-minimal': PricingPlansMinimal,
  'pricing-plans-standard-bold': PricingPlansBold,
  'pricing-tables-standard-standard': PricingTablesStandard,
  'pricing-tables-standard-minimal': PricingTablesMinimal,
  'pricing-tables-standard-bold': PricingTablesBold,
  'pricing-subscription-standard-standard': PricingSubscriptionStandard,
  'pricing-subscription-standard-minimal': PricingSubscriptionMinimal,
  'pricing-subscription-standard-bold': PricingSubscriptionBold,
}
